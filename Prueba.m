...
tic
[interseccion]=alinea(center,RUTAS,index);% t=5 min 55 seg
[~,dataCerromatoso]=alinea(center,RUTAS,index(1:2),interseccion);  %Datos de LaEnea2   t=1 min 57 seg
[~,dataEnea]=alinea(center,RUTAS,index(2:3),interseccion);         %Datos de GUAVIO2   t=2 min 21 seg
[~,dataGuavio]=alinea(center,RUTAS,index(3:4),interseccion);       %Datos de Cerro t=2 min 20 seg
toc